...
**UC1070** - Como gestor de Campus pretendo editar a informação (total ou parcial) de Edifício.
...
**Test 1:** *Editar edficio successfully*

**Test 2:** *Editar edficio unsuccessfully*
