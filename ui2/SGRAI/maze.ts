...
export default class Maze {
    ...
    private exitLocation: THREE.Vector3;
    ...
    constructor(parameters: MazeParameters) {
        this.onLoad = function (description: any) {
        ...
        this.onProgress = function (url: string, xhr: XMLHttpRequest) {
            console.log("Resource '" + url + "' " + (100.0 * xhr.loaded / xhr.total).toFixed(0) + "% loaded.");
        }

        this.onError = function (url: string, error: any) {
