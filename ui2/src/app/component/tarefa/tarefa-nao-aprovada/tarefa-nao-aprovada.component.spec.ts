...
import { TarefaNaoAprovadaComponent } from './tarefa-nao-aprovada.component';
...
describe('TarefaNaoAprovadaComponent', () => {
  let component: TarefaNaoAprovadaComponent;
  let fixture: ComponentFixture<TarefaNaoAprovadaComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ TarefaNaoAprovadaComponent ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(TarefaNaoAprovadaComponent);
